...
import { Plus, ShoppingBag, Gem, Sparkles } from 'lucide-react';
...
const RewardShop = ({ rewards, onAddReward, onBuyReward, totalRunes }) => {
              ...
              >
                <div className="flex flex-col gap-4">
                  <div>
                    ...
                    <div className="flex items-center gap-1.5 text-runes">
